...
import com.alex.security.CustomAuthenticationProvider;

@Configuration
@ComponentScan(basePackages = { "com.alex.security" })
//@ImportResource({ "classpath:config/security/webSecurityConfig.xml" })
@EnableWebSecurity
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AuthenticationProvider authProvider() {
    	final AuthenticationProvider authProvider = new CustomAuthenticationProvider();
    	return authProvider;
    }
    */
